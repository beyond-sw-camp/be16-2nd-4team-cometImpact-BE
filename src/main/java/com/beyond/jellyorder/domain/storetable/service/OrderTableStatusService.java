...
public class OrderTableStatusService {
     ...
     */
    @Transactional
    public UUID updateOrderTable(OrderTableUpdateReqDTO dto) {
        ...
        // unitOrder의 totalOrder가져오기.
        TotalOrder totalOrder = unitOrder.getTotalOrder();
        ...
        // fetch join 으로 한번에 해당 totalOrder의 orderMenuList가져오기
        List<OrderMenu> optionListByTotalOrder =
                orderMenuRepository.findAllActiveMenusWithOptionsByTotalOrderId(totalOrder.getId(), OrderStatus.CANCEL);
